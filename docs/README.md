...
| **05** | [Meeting Pipeline](./05_MEETING_PIPELINE.md) | Deep dive into post-processing meeting automation: Playwright bot, JS MediaRecorder, FFmpeg audio processing, Deepgram STT/Diarization, Speaker Attribution, and AI Task Extraction with notification dispatch. |
