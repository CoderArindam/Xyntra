...
class RealtimePresenceProvider(ParticipantPresenceProvider):
    """
    ...
    async def handle_join(self, event_id: str, participant_id: str, display_name: str, source: str = "EXTERNAL", timestamp: str = None) -> None:
        ...
        log = get_logger("presence.external")
        log.info("RealtimePresenceProvider received event", event_type="ParticipantJoined", participant_id=participant_id)
    ...
    async def handle_leave(self, event_id: str, participant_id: str, source: str = "EXTERNAL", timestamp: str = None) -> None:
        from app.meeting.logger import get_logger
        log = get_logger("presence.external")
        log.info("RealtimePresenceProvider received event", event_type="ParticipantLeft", participant_id=participant_id)
