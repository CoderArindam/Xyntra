  ...
  return (
    ...
    >
      ...
      >
        {/* Avatar */}
        <div
          className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center shadow-sm border mt-1 ${
            isUser
            ...
            {!isUser &&
              message.metadata?.executionStatus === "PARTIALLY_COMPLETED" && (
                <div className="mt-3 text-orange-700 text-sm font-medium border border-orange-200 bg-orange-50/50 p-3 rounded-lg flex items-center gap-2">
                  ⚠️ Execution completed partially. Some steps failed or were
                  skipped.
                </div>
              )}
