          ...
          <form id="create-project-form" onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4 pt-4 border-t border-brand-border">
              ...
              <div>
                ...
                <ProjectIconPicker 
                  value={formData.icon} 
                  onChange={(icon: any) => setFormData(prev => ({ ...prev, icon }))} 
                />
              </div>
              ...
              <div>
                ...
                <ProjectColorPicker 
                  ...
                  onChange={(color: any) => setFormData(prev => ({ ...prev, color }))} 
                />
              </div>
              ...
              <div>
                ...
                <ProjectCoverPicker 
                  ...
                  onChange={(gradient: any) => setFormData(prev => ({ ...prev, cover_gradient: gradient }))} 
                />
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <ProjectLeadSelector 
                    ...
                    onChange={(id: any) => setFormData(prev => ({ ...prev, project_lead_id: id }))} 
                  />
                </div>
                <div>
                  ...
                  <ProjectLeadSelector 
                    ...
                    onChange={(id: any) => setFormData(prev => ({ ...prev, default_assignee_id: id }))} 
                  />
                </div>
              </div>
            </div>
